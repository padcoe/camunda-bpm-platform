 ...
 */
package org.camunda.bpm.engine.impl.dmmn.entity.repository;
...
public class DecisionDefinitionManager extends AbstractManager {
  ...
  public void deleteDecisionDefinitionByDeploymentId(String deploymentId) {
    getDbEntityManager().delete(DecisionDefinitionEntity.class, "deleteDecisionDefinitionByDeploymentId", deploymentId);
  }
